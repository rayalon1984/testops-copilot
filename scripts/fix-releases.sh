#!/bin/bash
# Fix release tags and notes for TestOps Copilot
...
gh release create v3.0.0-beta.2 \
  --title "TestOps Copilot v3.0.0-beta.2 — E2E Test Coverage" \
...
gh release create v3.0.0-beta.3 \
  --title "TestOps Copilot v3.0.0-beta.3 — First-Run Experience" \
...
gh release create v3.0.0-beta.4 \
  --title "TestOps Copilot v3.0.0-beta.4 — Living Feature Specs" \
...
gh release edit v3.0.0-rc.1 \
  --title "TestOps Copilot v3.0.0-rc.1 — Specs Complete, Docs Polished" \
...
gh release create v3.0.0-rc.2 \
  --title "TestOps Copilot v3.0.0-rc.2 — Full Beta Coverage" \
